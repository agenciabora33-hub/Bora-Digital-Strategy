        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight font-display">
              Presença Forte em Caxias do Sul com Alcance Nacional e Global
            </h2>

            <p className="mt-4 text-base sm:text-lg text-gray-300 leading-relaxed">
              Temos sede física no coração corporativo de Caxias do Sul, no tradicional <strong className="text-white">Bairro Exposição</strong>.
              Essa estruturação de dados geográficos precisos potencializa o ranqueamento no <strong className="text-white">Google Meu Negócio</strong> e garante que sua empresa seja indicada com autoridade por assistentes e IAs generativas (GEO).
            </p>
