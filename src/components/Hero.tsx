        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center">
            ...
            <div className="relative z-20 w-full max-w-md">
              ...
              <div className="absolute -top-5 -right-3 sm:-right-5 z-30 hidden sm:flex items-center gap-2.5 bg-[#181B20]/95 border border-emerald-500/40 px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-2xl shadow-[0_12px_30px_rgba(0,0,0,0.5),0_0_20px_rgba(16,185,129,0.12)] backdrop-blur-md animate-float-medium pointer-events-none select-none">
                <span className="w-8 h-8 rounded-xl bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 flex items-center justify-center shrink-0">
                  <Zap className="w-4 h-4" />
                </span>
                <div className="leading-tight">
                  <p className="text-[10px] text-stone-400 uppercase font-bold tracking-wider">Velocidade</p>
                  <p className="text-xs sm:text-[13px] font-extrabold text-white tracking-tight">0.4s Core Web Vitals</p>
                </div>
              </div>

              {/* Floating 3D Satellite Badge 2 (Bottom Left) */}
              <div className="absolute -bottom-5 left-3 sm:-left-5 lg:-left-6 z-30 hidden sm:flex items-center gap-2.5 bg-[#181B20]/95 border border-orange-500/40 px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-2xl shadow-[0_12px_30px_rgba(0,0,0,0.5),0_0_20px_rgba(250,132,45,0.12)] backdrop-blur-md animate-float-reverse pointer-events-none select-none">
                <span className="w-8 h-8 rounded-xl bg-gradient-to-br from-orange-500/25 to-amber-500/15 border border-orange-500/30 text-[#FA842D] flex items-center justify-center shrink-0">
                  <Flame className="w-4 h-4 text-[#FA842D]" />
                </span>
                <div className="leading-tight">
                  <p className="text-[10px] text-stone-400 uppercase font-bold tracking-wider">Retorno</p>
                  <p className="text-xs sm:text-[13px] font-extrabold text-white tracking-tight flex items-center gap-1.5">
                    <span>+340% Novos Clientes</span>
