...
Gostaria de receber a análise de viabilidade e um plano para gerar contatos no WhatsApp!`;
  ...
  return (
    <section id="simulador" className="py-20 bg-[#121417] border-b border-gray-800/80 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 bg-[#181B20] border border-[#2A2E33] rounded-3xl p-6 sm:p-10 shadow-2xl">
            ...
            <div className="lg:col-span-7 space-y-6">
                    ...
                    return (
                      <button
                        ...
                        className={`text-left p-3.5 rounded-xl border transition-all flex items-start gap-3 cursor-pointer ${
                          isSelected
                            ? 'bg-orange-500/20 border-[#FA842D] text-white shadow-md'
                            : 'bg-stone-900/70 border-stone-800 text-gray-300 hover:border-stone-700'
                        }`}
                      >
                        <div className={`p-2 rounded-lg shrink-0 ${isSelected ? 'bg-[#FA842D] text-white' : 'bg-stone-800 text-gray-400'}`}>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-stone-900 border border-stone-700 rounded-xl p-3.5 text-sm text-gray-200 focus:ring-2 focus:ring-orange-500 focus:outline-none"
                >
                    ...
                    <button
                      ...
                      className={`p-2.5 rounded-lg border text-xs font-semibold transition-all ${
                        targetRegion === reg.id
                          ...
                          : 'bg-stone-900 border-stone-800 text-gray-400 hover:text-gray-200'
                      }`}
                    >
                      {reg.label}
                    </button>
